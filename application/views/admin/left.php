<nav id="left-column">
    ...
    <ul id="left-menu" class=" list-unstyled">
        <li>
            <a href="<?= BASE_URL ?>admin"><i class="fa fa-home fa-lg fa-fw"></i> <span>Trang chủ</span></a>
        </li>
        <li class="has-dropdown">
            <a href="javascript:void(0)"><i class="fa fa-truck fa-lg fa-fw"></i> <span>Quản lý sản phẩm</span></a>
        ...
        <li class="has-dropdown">
            <a href="javascript:void(0)"><i class="fa fa-edit fa-lg fa-fw"></i> <span>Quản lý bài viết</span></a>
            <ul class="list-unstyled dropdown">
        ...
        <li class="has-dropdown">
            <a href="javascript:void(0)"><i class="fa fa-globe fa-lg fa-fw"></i> <span>Quản lý website</span></a>
            <ul class="list-unstyled dropdown">
        ...
        <li>
            <a href="<?= BASE_URL ?>admin/user"><i class="fa fa-group fa-lg fa-fw"></i> <span>Quản lý tài khoản</span></a>
        </li>
    </ul>
</nav>